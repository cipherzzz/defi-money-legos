...
const IniswapV1Interface = require('../../build/contracts/UniswapV1.json');
const uniswapV1 = new ethers.Contract(IniswapV1Interface.networks[3].address, IniswapV1Interface.abi, wallet);
